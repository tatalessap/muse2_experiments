...
analyze_one_file(path_packages, path_file, path_folder, op, classifier, 5, random, "NaiveBayes")
...
#analyze_files(path_packages, path_files, path_folder, 'byonefile', 5, op, classifier, random, "NaiveBayes")
...
#analyze_files_seq(path_packages, path_ind, path_fe, path_folder, op, classifier, '_byseq', 'NaiveBayes')
